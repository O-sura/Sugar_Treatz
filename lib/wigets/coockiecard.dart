...
class _CookieCardState extends State<CookieCard> {
  ...
  Widget build(BuildContext context) {
    return GetX<ProductController>(
      builder: (controller) {
        return (controller.cookieList.isEmpty)
            ? Container(
            ...
            : Container(
                ...
                child: Column(
                  children: [
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  image: DecorationImage(
                                      image: AssetImage(
                                          "${controller.cookieList[widget.cardIndex].imagePath}"),
                                      fit: BoxFit.cover),
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  userController.addToFavourites(
                                      controller.cookieList[widget.cardIndex]);
                                },
                                onLongPress: () {
                    ...
                    Text(
                      "${controller.cookieList[widget.cardIndex].name}",
                    ...
                    Text(
                      "Flaver: ${controller.cookieList[widget.cardIndex].flavor}",
                      style: TextStyle(
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            "\$${controller.cookieList[widget.cardIndex].price.toStringAsFixed(2)}",
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
