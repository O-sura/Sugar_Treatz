...
class _ItemCardState extends State<ItemCard> {
  ...
  Widget build(BuildContext context) {
    return GetX<ProductController>(
      builder: (controller) {
        return (controller.cakeList.isEmpty)
            ? Container(
            ...
            : Container(
                ...
                child: Column(
                  children: [
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  image: DecorationImage(
                                      image: AssetImage(
                                          "${controller.cakeList[widget.cardIndex].imagePath}"),
                                      fit: BoxFit.cover),
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  userController.addToFavourites(
                                      controller.cakeList[widget.cardIndex]);
                                },
                                onLongPress: () {
                                  ...
                                  child: Center(
                                    child: Icon(
                                      (userController.isInFavoruites(controller
                                              .cakeList[widget.cardIndex].name))
                                          ? Icons.favorite
                                          : Icons.favorite_outline,
                                      color: (userController.isInFavoruites(
                                              controller
                                                  .cakeList[widget.cardIndex]
                                                  .name))
                                          ? Colors.red
                                          : null,
                    ...
                    Text(
                      "${controller.cakeList[widget.cardIndex].name}",
                    ...
                    Text(
                      "Flaver: ${controller.cakeList[widget.cardIndex].flavor}",
                      style: TextStyle(
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            "\$${controller.cakeList[widget.cardIndex].price.toStringAsFixed(2)}",
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
